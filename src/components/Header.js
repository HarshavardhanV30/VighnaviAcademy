...
export default function Header() {
  ...
  return (
    <>
      ...
      <nav style={{backgroundColor:'#030812',borderBottom:'1px solid rgba(255,255,255,.08)',padding:isMobile?'6px 18px':'6px 42px',display:'flex',justifyContent:'space-between',alignItems:'center',position:'sticky',top:0,zIndex:50,width:'100%',boxSizing:'border-box',minHeight:isMobile?'72px':'92px',overflow:'visible'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
          <Link to="/contact" onClick={closeMenu} className="cta-button" style={{backgroundColor:'#00D2C4',color:'#000',padding:isMobile?'11px 17px':'13px 25px',borderRadius:'28px',textDecoration:'none',fontWeight:'700',fontSize:isMobile?'13px':'16px',display:'inline-block',transition:'all .3s ease',whiteSpace:'nowrap',boxShadow:'0 4px 12px rgba(0,210,196,.18)'}}>
            Book Consultation&nbsp; →
          </Link>
